...
tape( 'the function returns the operation string associated with a BLAS operation side enumeration constant', function test( t ) {
	var i;
...
tape( 'the function returns `null` if unable to resolve an operation string', function test( t ) {
	var values;
	var i;
